...
- **b) \({\emptyset}\)** → **Ungültig.** das ist eine leere Menge; Alphabete müssen mindestens ein Symbol enthalten.
...
- **a)** „a,b,c“ → Σ = {a, b, c, ,} *(die Kommata dienen hier nur der Aufzählung)*
- **b)** „AabBabB“ → Σ = {A, a, b, B} *(Groß-/Kleinschreibung unterscheidet Symbole)*
- **c)** „aaaaa“ → Σ = {a}
- **d)** „(a+b)*2“ → Σ = {(, ), a, +, b, *, 2} *(als reine Zeichenfolge interpretiert)*
- **e)** „010001101“ → Σ = {0, 1}
- **f)** „I, II, III, IV, V, VI, VII, VIII, IX, X“ → Σ = {I, V, X} *(römische Zahlzeichen; Trennzeichen sind nicht Teil der Folge)*
- **g)** „1024“ → Σ = {0, 1, 2, 4}
